...
if (stockCount < 1) {
  console.log(`I'm going to eat some ${food.toLowerCase()}!`);
} else {
  console.log(`We need to get some more ${food.toLowerCase()}.`);
}
...
let vegetables = ['tomato', 'broccoli', 'spinach', 'carrot', 'kale'];

// Write the code to access the 3rd element of the Array, using bracket
// notation.

let elem3 = vegetables[2];

// Create a new variable "fruits" and assign it to an Array of 7
// different fruits.

let fruits = ['apple', 'orange', 'banana', 'cherry', 'pear', 'grape', 'nectarine']
